...
public class SqrtTest {
    ...
    public void testAverageNegativeNumbers() {
        ...
        Assertions.assertEquals(-2.0, sqrt.average(-1.0, -3.0));
        Assertions.assertEquals(-5.0, sqrt.average(-3.0, -7.0));
    }
    ...
    @Test
    public void testGoodWithNegativeNumbers() {
        Sqrt sqrt = new Sqrt(1.0);
        Assertions.assertFalse(sqrt.good(-4.0, 16.0));
        Assertions.assertFalse(sqrt.good(4.0, -16.0));
        Assertions.assertFalse(sqrt.good(-4.0, -16.0));
    }

    @Test
    public void testImproveWithNegativeNumbers() {
        Sqrt sqrt = new Sqrt(1.0);
        Assertions.assertEquals(-4.0, sqrt.improve(-4.0, 16.0));
        Assertions.assertEquals(-2.25, sqrt.improve(-2.0, 5.0));
    }
